...
CPU::CPU(MemoryMap& memoryMap) :
	...
	m_instructionSet{
		...
		{ &i::RET,  &i::IMP,  8  }, { &i::POP, &i::REG,   12     }, { &i::NOP, &i::IMP, 4     }, { &i::JP,  &i::ABS,  12 }, { &i::CALL, &i::ABS, 12 }, { &i::PUSH, &i::REG, 16 }, { &i::SUB,  &i::IMM, 8  }, { &i::RST, &i::MZP, 16 }, { &i::RET, &i::IMP, 8  }, { &i::RETI, &i::IMP, 16 }, { &i::NOP, &i::IMP, 4  }, { &i::JP,   &i::ABS,  12 }, { &i::NOP,  &i::IMP, 4  }, { &i::CALL, &i::ABS,  12 }, { &i::SBC,  &i::IMM, 8  }, { &i::RST,  &i::MZP, 16 },
		{ &i::LDH,  &i::MIDX, 12 }, { &i::POP, &i::REG,   12     }, { &i::NOP, &i::IMP, 4     }, { &i::LD,  &i::MIDX, 8  }, { &i::PUSH, &i::REG,  16 }, { &i::AND,  &i::IMM, 8  }, { &i::RST,  &i::MZP, 16 }, { &i::ADD,  &i::IMM, 16 }, { &i::JP,  &i::INR, 4  }, { &i::LD,  &i::ABS, 16 }, { &i::XOR,  &i::IMM, 8  }, { &i::RST, &i::MZP, 16 }, { &i::LDH,  &i::MIDX, 12 }, { &i::POP,  &i::REG, 12 }, { &i::LD,   &i::MIDX, 8  }, { &i::DI,   &i::IMP, 4  }, { &i::PUSH, &i::REG, 16 },
		{ &i::OR,   &i::IMM,  8  }, { &i::RST, &i::MZP,   16     }, { &i::LD,  &i::IMP, 12    }, { &i::LD,  &i::REG,  8, }, { &i::LD,   &i::ABS,  16 }, { &i::EI,   &i::IMP, 4  }, { &i::CP,   &i::IMM, 8, }, { &i::RST,  &i::MZP, 16 }
	}
{
	size_t size = 256;
